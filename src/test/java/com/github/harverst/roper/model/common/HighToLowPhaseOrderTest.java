...
public class HighToLowPhaseOrderTest
{
  @Test
  public void orderLowToHigh()
  {
    ...
    PhaseOrder<Integer> sorter = new HighToLowPhaseOrder();
    ...
    assertSame("Idx 0 should be 3", scores[0], sorted.get(3));
    assertSame("Idx 1 should be 3", scores[1], sorted.get(2));
    assertSame("Idx 2 should be 2", scores[2], sorted.get(1));
    assertSame("Idx 3 should be 1", scores[3], sorted.get(0));
  }
}
